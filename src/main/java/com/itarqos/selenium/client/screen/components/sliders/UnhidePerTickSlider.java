...
public class UnhidePerTickSlider extends SliderWidget {
    private static final int MIN = 1;
    private static final int MAX = 64;
    private final SeleniumConfig cfg;

    public UnhidePerTickSlider(int x, int y, int width, int height, int initial, SeleniumConfig cfg) {
    ...
    private static String label(int v) {
        return Text.translatable("selenium.settings.unhide_per_tick", clamp(v)).getString();
    }
}
