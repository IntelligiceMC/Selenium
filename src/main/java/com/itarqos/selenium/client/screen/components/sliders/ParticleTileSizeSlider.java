...
public class ParticleTileSizeSlider extends SliderWidget {
    private static final int MIN = 4;
    private static final int MAX = 64;
    private final SeleniumConfig cfg;

    public ParticleTileSizeSlider(int x, int y, int width, int height, int initial, SeleniumConfig cfg) {
    ...
    private static String label(int v) {
        return Text.translatable("selenium.settings.particle_tile_size", clamp(v)).getString();
    }
}
