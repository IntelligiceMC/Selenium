...
public class HiddenFramesSlider extends SliderWidget {
    private static final int MIN = 0;
    private static final int MAX = 60;
    private final SeleniumConfig cfg;

    public HiddenFramesSlider(int x, int y, int width, int height, int initial, SeleniumConfig cfg) {
    ...
    private static String label(int v) {
        return Text.translatable("selenium.settings.hidden_deprioritize", clamp(v)).getString();
    }
}
