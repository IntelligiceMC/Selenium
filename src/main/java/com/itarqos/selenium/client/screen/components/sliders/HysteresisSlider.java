...
public class HysteresisSlider extends SliderWidget {
    private static final int MIN = 0;
    private static final int MAX = 6;
    private final SeleniumConfig cfg;

    public HysteresisSlider(int x, int y, int width, int height, int initial, SeleniumConfig cfg) {
    ...
    private static String label(int v) {
        return Text.translatable("selenium.settings.hysteresis", clamp(v)).getString();
    }
}
