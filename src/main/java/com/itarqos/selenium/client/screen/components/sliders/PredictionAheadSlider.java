...
public class PredictionAheadSlider extends SliderWidget {
    private static final int MIN = 0;
    private static final int MAX = 6;
    private final SeleniumConfig cfg;

    public PredictionAheadSlider(int x, int y, int width, int height, int initial, SeleniumConfig cfg) {
    ...
    private static String label(int v) {
        return Text.translatable("selenium.settings.prediction_ahead_ticks", clamp(v)).getString();
    }
}
